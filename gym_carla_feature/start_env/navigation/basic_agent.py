...
The navigation also responds to traffic lights. """

import carla
from gym_carla_feature.start_env.navigation.agent import Agent, AgentState
...
class BasicAgent(Agent):
    """
    BasicAgent implements a basic navigation that navigates scenes to reach a given
    target destination. This navigation respects traffic lights and other vehicles.
    """
    ...
    def done(self):
        """
        Check whether the navigation has reached its destination.
        :return bool
        """
