...
import carla
from gym_carla_feature.start_env.navigation.controller import VehiclePIDController
from gym_carla_feature.start_env.misc import distance_vehicle, draw_waypoints
...
class LocalPlanner(object):
    ...
    def __init__(self, agent):
        """
        :param agent: navigation that regulates the vehicle
    ...
    def _init_controller(self):
        ...
        self.args_lat_city_dict = {
            ...
            'K_I': 0.5,
            'dt': 1.0 / self.FPS}
        self.args_lat_test_dict = {
            'K_P': 1.5,
            'K_D': 0.1,
            'K_I': 2.5,
            'dt': 1.0 / 5}
        self.args_long_test_dict = {
            'K_P': 0.75,
            'K_D': 0.25,
            'K_I': 0.35,
            'dt': 1.0 / 5}
    ...
    def run_step(self, target_speed=None, debug=False):
        ...
        if target_speed > 50:
            ...
            # args_lat = self.args_lat_test_dict
            # args_long = self.args_long_test_dict
