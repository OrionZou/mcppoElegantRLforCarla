...
import carla
from gym_carla_feature.start_env.misc import is_within_distance_ahead, is_within_distance, compute_distance


class AgentState(Enum):
    """
    AGENT_STATE represents the possible states of a roaming navigation
    """
    NAVIGATING = 1
...
class Agent(object):
    ...
    def _bh_is_vehicle_hazard(self, ego_wpt, ego_loc, vehicle_list,
        ...
        negative.
            ...
            :param proximity_th: threshold for the navigation to be alerted of
